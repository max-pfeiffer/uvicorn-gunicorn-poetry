...
def verify_container(container: UvicornGunicornPoetryContainerConfig) -> None:
    ...
    assert config_data['graceful_timeout'] == DEVELOPMENT_GUNICORN_CONFIG['graceful_timeout']
    ...
    assert config_data['worker_tmp_dir'] == DEVELOPMENT_GUNICORN_CONFIG['worker_tmp_dir']
